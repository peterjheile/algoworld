      ...
      <div className="mx-auto max-w-3xl">
        ...
        <section className="py-12">
          ...
          <div className="mt-6 flex flex-wrap gap-4">
            <Link
              href={`/clients/${encodeURIComponent(client.id)}/projects/${encodeURIComponent(project.id)}/milestones`}
              className="rounded-lg border border-zinc-300 bg-white px-4 py-2 text-sm font-medium hover:bg-zinc-100"
            >
              Manage milestones
            </Link>
            <Link
              href={`/clients/${encodeURIComponent(client.id)}/projects/${encodeURIComponent(project.id)}/updates`}
              className="rounded-lg border border-zinc-300 bg-white px-4 py-2 text-sm font-medium hover:bg-zinc-100"
            >
              Manage updates
            </Link>
