...
export default function ProjectUpdateError({ reset }: { reset: () => void }) {
  return (
    <main className="flex min-h-screen items-center justify-center bg-zinc-50 p-6 text-zinc-950">
      <div className="max-w-md text-center">
        ...
        <p className="mt-4 leading-7 text-zinc-600">
          We could not load or confirm the latest update details. If you were
          saving an update, check its current details before submitting again.
        </p>
